...
![Agent 任务模型冰山图](image/03-task-model-iceberg.png)

*图：用户的一句话请求只露出任务表面，目标、参与者、步骤、决策、异常、人工节点和完成证据共同构成水面下的真实任务。*
...
![任务状态比对话轮次更重要](../diagrams/svg/book1-03-user-research-and-task-modeling-01.svg)

[查看 Mermaid 源码](../diagrams/source/book1-03-user-research-and-task-modeling-01.mmd)
...
![双案例一：取消订阅或标准退款的任务模型](../diagrams/svg/book1-03-user-research-and-task-modeling-02.svg)

[查看 Mermaid 源码](../diagrams/source/book1-03-user-research-and-task-modeling-02.mmd)
...
![双案例二：有来源的企业知识问答任务模型](../diagrams/svg/book1-03-user-research-and-task-modeling-03.svg)

[查看 Mermaid 源码](../diagrams/source/book1-03-user-research-and-task-modeling-03.mmd)
...
[上一篇：机会识别与场景选择](02-opportunity-and-scenario-selection.md) · [篇章目录](README.md) · [下一篇：Agent 产品定义](04-agent-product-definition.md)
