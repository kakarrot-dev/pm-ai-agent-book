...
![Agent 自主等级与责任阶梯](image/04-autonomy-levels.png)

*图：从只回答到边界内自主执行，用户操作逐渐减少，产品责任与风险控制要求同步增加。*
...
![自主等级应按动作配置](../diagrams/svg/book1-04-agent-product-definition-01.svg)

[查看 Mermaid 源码](../diagrams/source/book1-04-agent-product-definition-01.mmd)
...
[上一篇：用户研究与任务建模](03-user-research-and-task-modeling.md) · [篇章目录](README.md) · [下一篇：交互、信任与控制权](05-interaction-trust-and-control.md)
