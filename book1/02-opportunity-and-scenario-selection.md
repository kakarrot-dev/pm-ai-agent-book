...
![一条从机会到首发场景的判断路径](../diagrams/svg/book1-02-opportunity-and-scenario-selection-01.svg)

[查看 Mermaid 源码](../diagrams/source/book1-02-opportunity-and-scenario-selection-01.mmd)
...
| 维度 | 需要回答的问题 | 当前证据 | 评分 |
| --- | --- | --- | --- |
| 用户痛点 | 用户正在付出什么成本 | 访谈、行为、工单或流程数据 | 1 至 5 |
| 任务频率 | 多久发生一次，覆盖多少用户 | 业务数据或抽样记录 | 1 至 5 |
| 任务价值 | 完成后改善什么结果 | 时间、收入、成本、体验或风险指标 | 1 至 5 |
| 步骤可观察性 | Agent 能否看到关键状态与反馈 | 系统和数据清单 | 1 至 5 |
| 结果可验证性 | 哪个外部证据代表成功或失败 | 状态、记录、引用或人工验收 | 1 至 5 |
| 环境可接入性 | 是否有合法、稳定、可维护的接入方式 | API、文件、身份和权限说明 | 1 至 5 |
| 错误代价 | 错误是否可发现、可撤销、可恢复 | 风险分析和历史事故 | 1 至 5 |
| 单位经济性 | 单次价值能否覆盖完整运行成本 | 成本估算和价值假设 | 1 至 5 |
...
[上一篇：AI Agent 产品入门](01-ai-agent-product-basics.md) · [篇章目录](README.md) · [下一篇：用户研究与任务建模](03-user-research-and-task-modeling.md)
